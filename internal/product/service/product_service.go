...
type ProductService interface {
	...
	GetAll(page, limit int, filter repository.ProductFilter) (*PaginateProduct, error)
...
func (s *productService) GetAll(page, limit int, filter repository.ProductFilter) (*PaginateProduct, error) {
