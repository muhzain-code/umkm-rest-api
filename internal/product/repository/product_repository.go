...
import (
	...
	"umkm-api/internal/product/model"
...
type ProductRepository interface {
	...
	FindAll(page, limit int, filter ProductFilter) ([]model.Product, int64, error)
...
func (r *productRepository) FindAll(page, limit int, filter ProductFilter) ([]model.Product, int64, error) {
	var products []model.Product
	var total int64

	db := r.db.Model(&model.Product{})
	db = ApplyProductFilter(db, filter)
