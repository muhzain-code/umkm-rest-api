...
type CategoryService interface {
	...
	GetAll(page, limit int, filter filter.CategoryFilter) (*PaginateCategory, error)
...
func (s *categoryService) GetAll(page, limit int, filter filter.CategoryFilter) (*PaginateCategory, error) {
